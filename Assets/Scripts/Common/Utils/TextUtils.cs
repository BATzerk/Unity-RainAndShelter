...
//      str.Split(new string[]{""}, System.StringSplitOptions.None);
    ...
    static public float TimeToSeconds (string timeString) {
        ...
        timeFloat += ParseFloat(secondsString);
        return timeFloat;
        }
...
//  }
    ...
    /** Pass in like this: "(-100.42, 320.0)". */
    ...
    public static Vector3 Vector3FromString(string str) {
        ...
        string xString = str.Substring(0, comma1);
        string yString = str.Substring(comma1+2, comma2-(comma1+2)); // starting after ", ".
        string zString = str.Substring(comma2+2); // starting after ", ".
        float x = ParseFloat(xString);
        float y = ParseFloat(yString);
        float z = ParseFloat(zString);
        return new Vector3(x, y, z);
        //int startChar = 1;
        //int endChar = vectorStr.IndexOf(",");
        //int lastEnd = endChar;
        //float x = ParseFloat(vectorStr.Substring(startChar, endChar - 1));

        //startChar = lastEnd + 1;
        //endChar = vectorStr.IndexOf(",", lastEnd);
        //lastEnd = endChar;
        //float y = ParseFloat(vectorStr.Substring(startChar, endChar));

        //startChar = lastEnd + 1;
        //endChar = vectorStr.IndexOf(",", lastEnd);
        //lastEnd = endChar;
        //float z = ParseFloat(vectorStr.Substring(startChar, endChar));
    ...
    public static Vector4 Vector4FromString(string str) {
        ...
        string wString = str.Substring(0, comma1);
        string xString = str.Substring(comma1+2, comma2-comma1-2); // starting after ", ".
        string yString = str.Substring(comma2+2, comma3-comma2-2); // starting after ", ".
        string zString = str.Substring(comma3+2); // starting after ", ".
        float w = ParseFloat(wString);
        float x = ParseFloat(xString);
        float y = ParseFloat(yString);
        float z = ParseFloat(zString);
        ...
        //int endChar = vectorStr.IndexOf(",");
        //int lastEnd = endChar;
        //float w = ParseFloat(vectorStr.Substring(startChar, endChar - 1));

        //startChar = lastEnd + 1;
        //endChar = vectorStr.IndexOf(",", lastEnd);
        //lastEnd = endChar;
        //float x = ParseFloat(vectorStr.Substring(startChar, endChar));
    ...
    public static Quaternion QuaternionFromString(string str) {
        Vector4 v4 = Vector4FromString(str);
